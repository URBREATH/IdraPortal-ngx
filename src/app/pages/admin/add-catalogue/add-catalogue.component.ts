  ...
  countries = [
    ...
    // node : Node;
	 ...
	 public add() {
		 ...
		 console.log('Publisher: ' + this.node.publisherName);
	     console.log('Descr: ' + this.node.description);
		 console.log('Home: ' + this.node.homepage);
	     console.log('API end: ' + this.node.host);
         console.log('Country: ' + this.node.country);
         console.log('Category: ' + this.node.category);
         console.log('Type: ' + this.node.nodeType);
         console.log('Active: ' + this.node.isActive);
         console.log('Refresh: ' + this.node.refreshPeriod);
...
*/
    ...
    public changedTypeHandler($event){
		...
		console.log('\MODE: ' + this.receivedMode);
	...
	public changedActiveHandler($event){
		...
		console.log('\ACTIVE after: ' + this.node.isActive);
	}
	...
	public async createNode(){
		...
		if(this.node.name==''){
			...
			//this.messagePublisher=this.publisherNameReq;
		}else {
		...
		if(this.node.host == ''){
			...
			//this.messageUrl=this.catalogueUrlReq;
		}else{
		...
		if(this.node.homepage == ''){
			...
			//this.messageHomepage=this.catalogueHomepageReq;
		}else{
